...
BLOG_AUTHOR = "Nicolas Bohorquez"  # (translatable)
BLOG_TITLE = "Ecclectic"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://nickman.blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://nickman.blog/"
BLOG_EMAIL = "nickman@alephsa.com"
BLOG_DESCRIPTION = "Heterogeneous thoughts assembled"  # (translatable)
